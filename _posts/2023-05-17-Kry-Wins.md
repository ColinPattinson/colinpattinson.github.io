...
comments: false
---
My time at Kry is approaching the end and I’ve decided to do a quick summary report to see what impact our team had. I have spoken about [some wins before](https://colinpattinson.github.io/kry-anniversary/) but here is a deeper dive. We were a small gang who were often responsible for video consultations, chat consultations, voice calls and messaging patients & this is what we achieved. 

# Care Portal 1.0 & the early days
When I arrived the company was still letting clinicians use a product called Care Portal 1.0. Some still use it to this day but over the last 14 months or so we’ve been moving people over to a new product called Kry Pro. In the markets we operated in we either had video consultations or physical consultations only. 

# Volume 
Given some of this might be commercially sensitive I’ll give % changes rather than raw numbers (sorry reader!).

From Feb 2022 until April 2023 we saw quite the jump in the number of consultations per month. Between those two dates we saw a 26.85% increase in net total meetings. A sign of healthy demand and we have a good chunk of returning users to our services. 
...
Volume wise the vast proportion of meetings are still video. Roughly 9/10. However a nice little chunk are chat meetings that did not exist when we first landed. Some of these types of consultations are only available in half of the markets we are in too so that deflates potential volumes for some of the newer services.
...
I suspect a big contributor was our work into [voice meetings as a fallback](https://colinpattinson.github.io/kry-anniversary/) but we’ve also been somewhat obsessive in trying to make sure consultations don’t fail. This includes refactoring, tackling nitty gritty bugs, monitoring our services well and of course adding some extra features.
...
Some of our team had been involved with some experiments into AI and helping to transcribe meetings and suggest some meeting notes. No actual patients or clinicians encountered this feature but from early prototyping it looks a potential way to shave clinicians time. This obviously came with a giant bucket of legal, ethical and moral questions that would need to be worked through but certainly technically possible.

One other idea we were excited to get into was thinking about how might we motivate clinicians to be more productive. This sounds more evil then it was but we wanted to use meaningful constructive feedback to encourage people to be happier and more efficient. For example we offer financial incentives if clinicians hit a certain performance level. We wanted to expose some of these so clinicians could better track if they stretched themselves then could attain some benefit. Financial benefits aren’t the only way to incentivise people of course and we were considering how can we keep clinicians happy and retain their employment if we gave joyful community rewards for the things they did (e.g. if they hit 1000 meetings in their career with us they’d unlock some reward). 
Sometimes feedback can be course correcting too. We know negative feedback to clinicians can be sensitive so we had some thoughts on how could we sift through comments like “clinician x did not give me y” because legitimately the patient was entitled to some certificate or drug to find more useful feedback that a clinician and their manager might get some use of discussing behind closed doors. 
All in all with the right incentive structure, and done well, we might see meeting lengths down, more meetings per hour up, patients still happy and clinicians even happier in their day to day work. 
...
#### What else was on the roadmap
Not everything was a win and we still wanted to investigate a bit more about some issues patients were facing. We have seen a 2% decrease from February 2022 to last month in patients telling us if they were helped or not from their consultations. I can’t honestly say why this is the case but it is absolutely worth looking into. 

We were keen to spend more time on the patient experience and fix some knotty issues such as a quirk with uploading photos or limiting the amount of things that can go wrong given circumstances like being on ‘Do Not Distrub’ mode, being logged out of the app when receiving a call and needing to login before accepting a call. 

# Easing the pain when things go wrong
To increase completion rates of meetings means also tackling issues that can arise before or during a call. [Voice as fallback](https://colinpattinson.github.io/kry-anniversary/) was the biggest success with almost 70% of people using the feature connecting with a patient when they could not via traditional video meetings and potentially saving us from a no show. 
...
# Reflections
There are probably many more stats I could share but I hope by now you get the picture. The team was genuinely a total delight and we achieved a lot in a short-ish time together. One day I’d love to get the dream team back together but for now we’ll need to reflect on a job well done.
