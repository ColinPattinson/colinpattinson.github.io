...
# How the app looked for patients
A few screens just to set the context of what patients would see, the vast majority of bookings were remote video consultations to speak to doctors when I first joined;

![Intro screen to Kry app to make a booking](https://github.com/ColinPattinson/colinpattinson.github.io/blob/master/assets/img/Kry%20(1).png?raw=true)
...
![Inbox for patient messages](https://github.com/ColinPattinson/colinpattinson.github.io/blob/master/assets/img/Kry%20(5).png?raw=true)

## Use of AI to help with note-taking
We additionally worked on trying to reduce the burden of note-taking by using AI to help clinicians process cases.
