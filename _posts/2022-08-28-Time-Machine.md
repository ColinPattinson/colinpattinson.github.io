...
comments: false
---
I am sitting here with access to [OpenAI’s DALL-E 2 tool](https://labs.openai.com/) and some free credits and feeling ready for a lark. 

# Context
First, let's set the scene:

## What is DALL-E 2? 
It is an AI system that has been fed a lot of images in order for a human to write a free text prompt and create some original art or image. 

I probably should add that almost certainly the training data used is biased, you can read smarter people than me about this issue but worth looking into. Likewise, there are deep concerns about art created from parroting real artists. Interesting topics but will not dive deep into these for a silly blog post.

## What should I try to create?
I’ve just listened to an amazing podcast as I was out and about which smushes a lot of my interests together.
...
This combines history, comedy, time, politics & Geordie’s. I’ve pulled out x3 interesting snippets and I’m going to try and see if I can visualise these nuggets!
...
# The Experiment
This web page is going to be very very very heavy with images! I’ve tried to compress them but am very sorry for the plethora of images thrown your way below.
...
## Smelling Clock
We’ve not always used dials and our eyes to sense time. We’ve had cockerels cock a doodle do-ing us in our ears. We’ve also used our noses.
...
In essence different smells can indicate different times. Perhaps this already happens as the faint whiff of coffee and bacon butty’s or freshly eaten cheerios is an indicator of morning in some parts of the world. Just googling this I am finding the idea is not dead with the Guardian writing [Wake up and smell the bacon-scented iPhone alarm clock](https://www.theguardian.com/technology/2014/mar/06/wake-up-and-smell-the-bacon-scented-iphone-alarm-clock) and 2,685 people [investing in a smelly alarm clock](https://www.indiegogo.com/projects/sensorwake-trio-the-scent-based-alarm-clock#/). 
...
When I tried “Dada clock shaped like a nose” it got possibly more disturbing.
...
So with that wholesome image in our heads lets try recreate the scene.

### Results
OK… not quite wholesome results using…
...
I then tried a variation of “A wholesome Johnny Cash playing his guitar next to a grandfather clock in the style of Hayao Miyazaki (Studio Ghibli)” which did produce something relatively sweet.
...
Just to be wild I thought let's bow out with something a bit more rock’n’roll.
...
Overall, not bad actually. Not perfect but largely these hit my brief quite well.

# Conclusion
Well that was entirely superfluous. Some might say it was a waste of time, I would say listen to the podcast and reimagine what time and timekeeping means. I am left impressed and scared. 
